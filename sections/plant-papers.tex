...
\subsection{Ye (2013) Evolutionary analyses of non-family genes in plants}
    ...
    \begin{figure}[!hbpt] \centering \includegraphics{ye_nonfamily-fig1}
    ...
    \begin{figure}[!hbpt] \centering \includegraphics{ye_nonfamily-fig3}
    ...
    \begin{figure}[!hbpt] \centering \includegraphics{ye_nonfamily-fig8}
